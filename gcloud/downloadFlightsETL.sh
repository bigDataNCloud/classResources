...
if [ "${CLOUD_SHELL}" != "true" ]
then
    echo "WARNING: Expecting this script to be run from Google Cloud Shell. It will only work if you have Google CLI (Google's command line interface) installed locally."
fi
