# MGMT 590 Big Data in the Cloud
...
You can download the latest version of the repository as a zip file or set up Git on your local machine to synchronize a local repository with the one in GitHub. If you are not familiar with Git, it may be a lot to swallow in a short time and you may do better going the manual route.

### Manually Installing by Downloading a Compressed Snapshot
1. Download the code as a zip file and unzip the file. This will create a folder named classResources-master with all the contents of the zip file expanded.
